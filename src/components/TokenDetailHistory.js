    ...
    loadScript(
      ...
      (error, script) => {
        if (error) {
          ...
          window.initMap = () => {
            const myLatLng = { lat: parseFloat(location.state.latitude), lng: parseFloat(location.state.longitude) };
      ...
      <div className="token-history">
        ...
        <div className="token-history-details">
          <div className="profile-p1">
            ...
            <div className="profile-p1-menu">
              ...
              <div className="profile-p1-com">
                ...
                <div className="com-ans">{location.state.vpn}</div>
              </div>
              <div className="profile-p1-com">
          ...
          <div className="profile-p1">
            ...
            <div id="map" style={{ height: "400px", width: "600px", marginTop: "20px" }}></div>
          </div>
        </div>
      </div>
    </div>
